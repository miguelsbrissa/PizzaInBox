...
HTML;
                    ...
                    $stm->execute([$this->cli->getNome(), $this->cli->getEndereco(), $this->cli->getSenha(), $this->cli->getIdade(), $this->cli->getAtivo(), $this->cli->getCodigo() ]);
...
HTML;
                ...
                $stm->execute([$this->cli->getCodigo() ]);
